...
1. **Arquitectura y Organización del Código**
   - Revisión de la estructura de carpetas (src), separación de responsabilidades y cumplimiento de principios SOLID.
...
5. **Desempeño y Escalabilidad**
   - Análisis de cuellos de botella en la comunicación con servicios externos.
   - Uso eficiente de recursos y asincronía.
...
7. **Automatización y DevOps**
   - Scripts de despliegue (run.py), y CI/CD.
